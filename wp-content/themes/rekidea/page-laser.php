...
<div class="breadcrumbs">
    <div class="container">
<!--        <p>Главная  > Лазерная резка</p>-->
        <p><a href="/">Главная</a> > Лазерная резка</p>
    </div>
</div>
<!--*************************************-->
...
<div class="laser-top-banner__wrapper">
    <div class="container">
        <div class="laser-top-banner">
            ...
            <p>
                <img src="<?= get_template_directory_uri()?>/img/laser-page/check-box.png" alt="">
                Воспользуйтесь нашим складом или привозите свой материал
            </p>
            <p>
                <img src="<?= get_template_directory_uri()?>/img/laser-page/check-box.png" alt="">
...
<div class="craft-acrylic-block container">
    ...
    <div class="craft-acrylic-block__content">
        ...
        <p>
            Поможем скорректировать техническое задание
            и разработаем проект.
            Подскажем какие материалы лучше использовать.
            Сами подготовим файлы или скорректируем макет.
            Разработаем дизайн и сделаем фотопривязку.
        </p>
...
<div class="acryl-cutting-block__wrapper clearfix wow slideInLeft">
     <div class="container">
        ...
        <div class="acryl-cutting-block__content">
            ...
            <p>
                Изделия из акрила любой сложности и формы<br>
                Идеальный и прозрачный рез без<br> дополнительной обработки
            </p>
            <a href="#" class="laser-btn-order">Заказать</a>
        </div>
     </div>
