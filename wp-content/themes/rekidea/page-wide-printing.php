...
<div class="breadcrumbs">
    <div class="container">
        <p><a href="/">Главная</a> > <a href="/price">Цены</a> > Широкоформатная печать</p>
        </div>
    </div>
</div>
<!--*************************************-->
...
<div class="wide-printing__wrapper container clearfix">
    ...
    <div class="wide-printing__content">
        <div class="row">
            <div class="wide-printing__content-title">
        ...
        <div class="row">
            ...
            <div class="var-1">
                <div class="var-1__title">
                    <p>720 dpi</p>
                    <p>Ламинация</p>
                </div>
                <div class="var-1__td">
                    <p class="hot-icon">250</p>
                    <p>410</p>
                </div>
                <div class="var-1__td">
                    <p class="hot-icon">280</p>
                    <p>440</p>
                </div>
            </div>
            <div class="var-1">
                ...
                <div class="var-1__td">
                    <p class="hot-icon">320</p>
                    <p>480</p>
                </div>
                <div class="var-1__td">
                    <p class="hot-icon">350</p>
                    <p>510</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="var-2">
                ...
                <div class="var-2__td">
                    <p>300</p>
                    <p>380</p>
                    <p class="hot-icon">430</p>
                </div>
                <div class="var-2__td">
                    <p>400</p>
                    <p>480</p>
                    <p class="hot-icon">540</p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="var-1">
                ...
                <div class="var-1__td">
                    <p>350</p>
                    <p class="hot-icon">500</p>
                </div>
                <div class="var-1__td">
                    <p>400</p>
                    <p class="hot-icon">560</p>
                </div>
            </div>
            <div class="var-1">
                <div class="var-1__title">
