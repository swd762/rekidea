...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 16 2020 г., 21:33
...
(635, '_site_transient_timeout_theme_roots', '1581877439', 'no'),
(636, '_site_transient_theme_roots', 'a:1:{s:7:\"rekidea\";s:7:\"/themes\";}', 'no');
...
(185, 1, '2020-02-03 15:02:14', '2020-02-03 12:02:14', '<div class=\"feedback-field\">\r\n[text feedback-name placeholder \"Имя\"]\r\n</div>\r\n<div class=\"feedback-field\">\r\n[tel feedback-phone placeholder \"Телефон\"]\r\n</div>\r\n<div class=\"feedback-submit\">\r\n[submit value \"Перезвоните мне\" ]\r\n</div>\r\n<div class=\"private_term_agree\">\r\nНажимая кнопку «Отправить», я <a href=\"/404\">даю свое согласие</a> на обработку персональных данных.\r\n</div>\n1\nRek \"[your-subject]\"\nRek <wordpress@rek.local>\nswd.admin@mail.ru\nFrom: [your-name] <[your-email]>\r\nSubject: [your-subject]\r\n\r\nMessage Body:\r\n[your-message]\r\n\r\n-- \r\nThis e-mail was sent from a contact form on Rek (http://rek.local)\nReply-To: [your-email]\n\n\n\n\nRek \"[your-subject]\"\nRek <wordpress@rek.local>\n[your-email]\nMessage Body:\r\n[your-message]\r\n\r\n-- \r\nThis e-mail was sent from a contact form on Rek (http://rek.local)\nReply-To: swd.admin@mail.ru\n\n\n\nThank you for your message. It has been sent.\nThere was an error trying to send your message. Please try again later.\n\nThere was an error trying to send your message. Please try again later.\nYou must accept the terms and conditions before sending your message.\nThe field is required.\nThe field is too long.\nThe field is too short.\nThe date format is incorrect.\nThe date is before the earliest one allowed.\nThe date is after the latest one allowed.\nThere was an unknown error uploading the file.\nYou are not allowed to upload files of this type.\nThe file is too big.\nThere was an error uploading the file.\nThe number format is invalid.\nThe number is smaller than the minimum allowed.\nThe number is larger than the maximum allowed.\nThe answer to the quiz is incorrect.\nThe e-mail address entered is invalid.\nThe URL is invalid.\nThe telephone number is invalid.', 'phone-feedback-top-main', '', 'publish', 'closed', 'closed', '', 'phone-feedback-top-main', '', '', '2020-02-16 21:00:06', '2020-02-16 18:00:06', '', 0, 'http://rek.local/?post_type=wpcf7_contact_form&#038;p=185', 0, 'wpcf7_contact_form', '', 0),
...
--
ALTER TABLE `wp_postmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1365;
--
